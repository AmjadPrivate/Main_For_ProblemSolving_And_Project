...
int ReadIntegerNumber(string Message, string MessageInCaseInvalidNumber) {
  int Number = 0;
  ...
  // If cin.fail() == true, this while loop will work and this mean the input user entered is wrong, this Procese mean Validation Number.
  ...
  while (cin.fail()) 
  {
    ...
    cout << MessageInCaseInvalidNumber << endl;
    cin >> Number;

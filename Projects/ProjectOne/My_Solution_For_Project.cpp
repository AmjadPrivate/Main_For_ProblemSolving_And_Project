...
void RoundResult(int RoundNumber, enUsersInput PlayerInput, enUsersInput ComputerInput ,enHowIsWon Winner)
{
    ...
    cout << "Player1 Choice:  " << ConvertEnumToString_UsersInputs(PlayerInput) << endl;
    cout << "Computer Choice: " << ConvertEnumToString_UsersInputs(ComputerInput) << endl;
    cout << "Round Winner:    " << ConvertEnumToString_HowIsWinner(Winner) << endl;
...
void TheFinalResult(stGameResults& GameResults)
{
    ...
    cout << "\t\t\tFinal Winner       :  " << ConvertEnumToString_HowIsWinner(GetTheFinalWinner(GameResults.Computer_Points, GameResults.Player_Points));
